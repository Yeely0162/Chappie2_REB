...
struct SynologyConfig{
  ...
  String SidAPI = "https://XXXXXXXXXXX/webapi/auth.cgi?api=SYNO.API.Auth&version=3&method=login&account="+ User +"&passwd="+ Password +"";
  String CPUAPI = ("https://XXXXXXXXXXXX/webapi/entry.cgi?api=SYNO.Virtualization.Cluster&method=get_host&version=1&object_id=NOTE_ID&_sid=");
  String LogoutAPI = ("https://XXXXXXXXXXX/webapi/entry.cgi?api=SYNO.API.Auth&version=6&method=logout&_sid=");
  String StorageAPI = ("https://XXXXXXXXXXXX/webapi/entry.cgi?api=SYNO.Core.System&type=storage&method=info&version=3&_sid=");
  String SystemInfoAPI = "https://XXXXXXXXXXXXXXX/webapi/entry.cgi?api=SYNO.Core.System&method=info&version=3&_sid=";
}SyConfig;
struct SynologyInfo{
